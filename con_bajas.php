        ...
        <article class="pad_left3">
            <?php
                ...
                $consulta=mysql_query("SELECT `equipo`.`tipo_eq` , `equipo`.`modelo` , `equipo`.`capacidad` , `equipo`.`serie` , `plaza`.`nombre` ,
                    `instalaciones`.`ubicacion` , `instalaciones`.`filial` , `instalaciones`.`nombre` , `area`.`nombre` , `equipo`.`nombre` 
                    ,`personal`.`nombre`,`status`.`nombre`
                FROM `status` ,`equipo` , `plaza` , `instalaciones` , `area` , `personal` , `area_x_instalaciones`
                ...
                AND `equipo`.`id_area` = `area`.`id_area` and `status`.`id_status`=`equipo`.`status` and `equipo`.`status`=4
